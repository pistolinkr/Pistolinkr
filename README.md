...
```bash
# 패치 버전 (버그 수정)
npm run deploy:auto:patch

# 마이너 버전 (새 기능)
npm run deploy:auto:minor

# 메이저 버전 (주요 변경사항)
npm run deploy:auto:major
...
### 버전 체계
- **Major**: 주요 변경사항, 호환성 깨짐 (1.0.0 → 2.0.0)
- **Minor**: 새 기능 추가 (1.0.0 → 1.1.0)
- **Patch**: 버그 수정, 개선사항 (1.0.0 → 1.0.1)

### 버전 정보 확인
- `package.json`의 `version` 필드
- HTML 메타 태그: `<meta name="version" content="1.0.0">`
- 푸터의 버전 표시
